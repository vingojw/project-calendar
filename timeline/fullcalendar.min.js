...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.reportEventResize = function (eventInstance, eventMutation, el, ev) {
        ...
        this.triggerEventResize(eventInstance, eventMutation.dateMutation.endDelta, undoFunc, el, ev,eventMutation.dateMutation);//为了能拖前面的时候也能更新
    };
    // Triggers event-resize handlers that have subscribed via the API
    View.prototype.triggerEventResize = function (eventInstance, durationDelta, undoFunc, el, ev,em) {
